...
?>
<?php 
pti_set_post_type_icon( 'slider', 'picture-o' );
pti_set_post_type_icon( 'noticia', 'calendar' );
pti_set_post_type_icon( 'tipo_de_cancer', 'medkit' );
pti_set_post_type_icon( 'doctor', 'user-md' );
pti_set_post_type_icon( 'award', 'trophy' );
pti_set_post_type_icon( 'administracion', 'user' );
pti_set_post_type_icon( 'director', 'users' );
pti_set_post_type_icon( 'publicacion', 'thumb-tack' );
pti_set_post_type_icon( 'tratamiento', 'stethoscope' );
pti_set_post_type_icon( 'testimonio', 'comments' );
pti_set_post_type_icon( 'seguro', 'lock' );
?>
<?php 
...
function my_custom_login_logo() {
	...
	body.login{
		...
		background-image:url('.get_bloginfo('template_directory').'/images/iram-back.jpg) !important;
...
border-radius: 4px 4px 4px 4px;
	...
	.login #nav a:hover, .login #backtoblog a:hover{
        ...
        .login h1 a { background-image:url('.get_bloginfo('template_directory').'/images/iram-logo.png) !important;
